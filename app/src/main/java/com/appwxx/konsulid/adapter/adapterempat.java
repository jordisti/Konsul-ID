...
public class adapterempat extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<data> items;
    Context context;

    public adapterempat(Activity activity, List<data> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_rowproduk, null);
        ...
        TextView harga = (TextView) convertView.findViewById(R.id.textView16);
        ...
        harga.setText(data.getHargaProduk());
