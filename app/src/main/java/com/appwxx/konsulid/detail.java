    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chat.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String biaya = intents.getStringExtra("biaya");

                Intent intent = new Intent(
                        detail.this,
                        daftarkonsultasi.class);
        ...
        mAdapters2 = new detail.StoreAdapter2(getApplicationContext(), itemsList2);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getApplicationContext(), 2);
        recyclerView2.setLayoutManager(mLayoutManager);
        recyclerView2.addItemDecoration(new detail.GridSpacingItemDecoration(2, dpToPx(2), true));
