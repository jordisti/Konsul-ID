...
public class riwayatchat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend = (Button) findViewById(R.id.penilaian);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String idKonsultasi = intents.getStringExtra("idKonsultasi");

                Intent intent = new Intent(
                        riwayatchat.this,
                        ratingdokter.class);
                intent.putExtra("idKonsultasi", idKonsultasi);
