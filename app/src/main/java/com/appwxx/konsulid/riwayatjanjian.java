...
public class riwayatjanjian extends AppCompatActivity {
    ...
    adapterdua adapter;
    int success;
    private static final String TAG = riwayatkonsultasi.class.getSimpleName();
    private static String url_cari     = AppConfig.URL_modul + "selectpenggunakonsultasi.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new adapterdua(riwayatjanjian.this, itemList);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(status.equals("Konsultasi")){
                    ...
                    Intent intent = new Intent(view.getContext(), bayartransfer.class);
