...
public class artikel extends AppCompatActivity {
    ...
    private static final String URL2 = AppConfig.URL_modul + "selectinformasi.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapters2 = new artikel.StoreAdapter2(getApplicationContext(), itemsList2);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getApplicationContext(), 1);
        recyclerView2.setLayoutManager(mLayoutManager);
        recyclerView2.addItemDecoration(new artikel.GridSpacingItemDecoration(2, dpToPx(2), true));
